...
class Api {
  ...
  public async createLead(body: LeadList): Promise<AxiosResponse> {
    try {
      ...
      const res = await axios.post(
        this.base_url + endPoint.getLeads,
        body,
        config,
      );
      return res;
  ...
  public async getContactById(id: string): Promise<AxiosResponse> {
    try {
      const config = this.fetchConfig();
      const res = await axios.get(
        this.base_url + endPoint.getContacts + `/${id}`,
        config,
      );
      return res;
    } catch (err) {
  ...
  public async createContact(body: ContactsList): Promise<AxiosResponse> {
    try {
      const config = this.fetchConfig();
      const res = await axios.post(
        this.base_url + endPoint.getContacts,
        body,
        config,
      );
      return res;
  ...
  public async getCallLogs(
    ...
    try {
      ...
      const config = this.fetchConfig();
      const res = await axios.get(
        this.base_url + endPoint.calls + `?${urlParams}`,
        config,
      );
      return res;
    } catch (err) {
  ...
  async createOrder(body: Partial<OrdersList>): Promise<AxiosResponse> {
    try {
      const config = this.fetchConfig();
      const res = await axios.post(
        this.base_url + endPoint.getOrders,
        body,
        config,
      );
      return res;
  ...
  async getFullLeads(): Promise<AxiosResponse> {
    try {
      const config = this.fetchConfig();
      const res = await axios.get(
        this.base_url + endPoint.getFullLeads,
        config,
      );
      return res;
    } catch (err) {
  ...
  async getFullOrders(): Promise<AxiosResponse> {
    try {
      const config = this.fetchConfig();
      const res = await axios.get(
        this.base_url + endPoint.getFullOrders,
        config,
      );
      return res;
    } catch (err) {
